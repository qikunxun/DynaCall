...
class Docstore:
    """Simple Docstore interface to replace langchain.docstore.base.Docstore"""
    def search(self, query: str) -> Union[str, Document]:
        raise NotImplementedError
    
    async def asearch(self, query: str) -> Union[str, Document]:
        raise NotImplementedError
...
class ReActWikipedia(Docstore):
    ...
    def search(self, entity: str, is_retry: bool = False) -> Union[str, Document]:
        ...
        proxy = os.environ.get("WIKIPEDIA_PROXY") or None
        proxies = {"http": proxy, "https": proxy} if proxy else None
        search_url = f"https://en.wikipedia.org/w/index.php?search={entity_}"
        response_text = requests.get(search_url, headers=headers, proxies=proxies).text
        ...
        if "Similar:" in result:
            ...
            response_text = requests.get(
                search_url, headers=headers, proxies=proxies
            ).text
