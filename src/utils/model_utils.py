...
def get_model(
    ...
    if model_type == "openai":
        llm = ChatOpenAI(
            ...
            openai_api_base=os.environ.get("OPENAI_API_BASE", "https://api.openai.com/v1"),  # type: ignore
        )
        # llm = ChatOpenAI(
        #     model_name=model_name,  # type: ignore
        #     openai_api_key="any",  # type: ignore
        #     openai_api_base="http://47.107.57.1:11110/v1",
        #     streaming=stream,
        #     temperature=temperature,
        # )
        ...
        llm = AzureChatOpenAI(
            ...
            # streaming=args.use_early_execution,
        )
